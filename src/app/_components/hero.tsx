...
export function Hero(){
    return(
        <section className="bg-[#E84C3D] text-white relative overflow-hidden">
            ...
            <div>
                <Image src={dogImg} alt='Foto do doguinho' fill sizes='100vw' priority className='object-cover opacity-60 lg:hidden'/>
            ...
            <div className='container mx-auto pt-16 pb-16 md:pb-0 px-4 relative'>
                <article className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                        ...
                        <div className="mt-8">
                            ...
                            <div className='flex mt-4'>
                                <div className='w-32 hidden lg:block'>
                                    <Image src={catImg} alt='foto do gatinho' quality={100} className='object-fill'/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='hidden md:block h-full relative'>
                        <Image src={dogImg} alt='Foto do doguinho' className='object-contain' fill sizes='(max-width: 768px) 0vw, 50vw' quality={100} priority/>
                    </div>
                </article>
            </div>
        </section>
